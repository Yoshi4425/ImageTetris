...
public class Tet3 extends TetriMino {	//黃緑 Zミノ 
	
	public Tet3() {
		super(new int[][]{{1,center},{1,center-1},{0,center},{0,center+1}});
	}
	
	public int[][] defP(){
		return new int[][]{{1,center},{1,center-1},{0,center},{0,center+1}};
	}
	...
	public boolean changeTo0(int y, int x) {
		newP = new int[][]{{y,x},{y,x-1},{y-1,x},{y-1,x+1}};
