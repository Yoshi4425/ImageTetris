...
public class Tet2 extends TetriMino {	//ピンク Sミノ
	
	public Tet2() {
		super(new int[][]{{1,center},{0,center-1},{0,center},{1,center+1}});
	}
	
	public int[][] defP(){
		return new int[][]{{1,center},{0,center-1},{0,center},{1,center+1}};
	}
	...
	public boolean changeTo0(int y, int x) {
		newP = new int[][]{{y,x},{y-1,x-1},{y-1,x},{y,x+1}};
